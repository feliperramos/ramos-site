      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">leave your email here</h2>
            <p className="mt-4 text-lg leading-8 text-gray-300">Leave your email below so I can contact you.</p>
          ...
          <dl className="grid grid-cols-1 gap-x-10 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              <dt className="mt-4 font-semibold text-white">Menu</dt>
            ...
            <div className="flex flex-col items-start">
              <dt className="mt-4 font-semibold text-white">Social Media</dt>
              ...
              <dt className="mt-4 font-semibold text-white">Made with 💙 </dt>
              <dt className="font-semibold text-white">using <a className="hover:text-sky-600" href="https://nextjs.org">Next.js</a></dt>
            </div>
          </dl>
        </div>
      </div>
